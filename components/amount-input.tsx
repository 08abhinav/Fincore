  ...
  return (
    <div className="relative">
      <TooltipProvider>
        <Tooltip delayDuration={100}>
          ...
          <TooltipContent
            ...
            align="center"            
            sideOffset={8}            
            className="z-50 rounded-md bg-slate-800 px-3 py-1.5 text-xs text-white shadow-md animate-in fade-in-50"
            >
      ...
      <CurrencyInput
        ...
        disabled={disabled}
        className="pl-10 file:text-foreground placeholder:text-muted-foreground selection:bg-primary 
