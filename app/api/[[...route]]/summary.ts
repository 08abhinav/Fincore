...
import { calcuatePercentageChange, fillMissingDays } from "@/lib/utils";
...
.get(
    ...
    async(c) =>{
        ...
        const incomeChange = calcuatePercentageChange(
            currentPeriod.income,
            lastPeriod.income
        )

        const expensesChange = calcuatePercentageChange(
            currentPeriod.expenses,
            lastPeriod.expenses
        )

        const remainingChange = calcuatePercentageChange(
